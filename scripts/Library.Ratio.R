...
ontario_library_stats_1999 <- read_csv("../data18/ontario_library_stats_1999.csv")
ontario_library_stats_2000 <- read_csv("../data18/ontario_library_stats_2000.csv")
ontario_library_stats_2001 <- read_csv("../data18/ontario_library_stats_2001.csv")
ontario_library_stats_2002 <- read_csv("../data18/ontario_library_stats_2002.csv")
ontario_library_stats_2003 <- read_csv("../data18/ontario_library_stats_2003.csv")
ontario_library_stats_2004 <- read_csv("../data18/ontario_library_stats_2004.csv")
ontario_library_stats_2005 <- read_csv("../data18/ontario_library_stats_2005.csv")
ontario_library_stats_2006 <- read_csv("../data18/ontario_library_stats_2006.csv")
ontario_library_stats_2007 <- read_csv("../data18/ontario_library_stats_2007.csv")
ontario_library_stats_2008 <- read_csv("../data18/ontario_library_stats_2008.csv")
ontario_library_stats_2009 <- read_csv("../data18/ontario_library_stats_2009.csv")
ontario_library_stats_2010 <- read_csv("../data18/ontario_library_stats_2010.csv")
ontario_library_stats_2011 <- read_csv("../data18/ontario_public_library_statistics_2011_open_data_may_22_csv_final.csv")
ontario_library_stats_2012 <- read_csv("../data18/ontario_public_library_statistics_2012_open_data_may_22_2015_csv_final_9.csv")
ontario_library_stats_2013 <- read_csv("../data18/ontario_public_library_statistics_2013_open_data_may_22_2015_csv_final.csv")
ontario_library_stats_2014 <- read_csv("../data18/ontario_public_library_statistics_2014_open_data_csv_february_17_2016.csv",skip=1) #first row needs to be skipped to import headers properly
ontario_library_stats_2015 <- read_csv("../data18/2015_ontario_public_library_statistics_open_data_dec_2017rev.csv")
ontario_library_stats_2016 <- read_csv("../data18/ontario_public_library_statistics_open_data_2016.csv")
...
write.csv(libraries2000_2010, "../data18/merged/libraries2000_2010.csv")
...
# Uncomment if you need to see the file in Excel
write.csv(libraries2011_2016, "../data18/merged/libraries2011_2016.csv")
...
# Uncomment if you need to see the file in Excel
write.csv(libraries2000_2016, "../data18/merged/libraries2000_2016.csv")
...
# Uncomment if you need to see the file in Excel
write.csv(libraries2000_2016_by_city, "../data18/merged/libraries2000_2016_by_city.csv")
...
write.csv(mylist, "../data18/merged/mylist.csv")
...
write.csv(stdValuesList, "../data18/merged/stdValuesList.csv")
